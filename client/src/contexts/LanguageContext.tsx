...
const translations = {
  en: {
    ...
    'hero.tagline': 'A renovated 2-bedroom apartment for 4, a 3-minute walk from the sand. Book direct from €130 a night — no booking fees.',
  ...
  nl: {
    ...
    'hero.tagline': 'Gerenoveerd appartement met 2 slaapkamers voor 4 personen, op 3 minuten lopen van het strand. Boek direct bij de eigenaar vanaf €130 per nacht — zonder boekingskosten.',
  ...
  fr: {
    ...
    'hero.tagline': 'Appartement rénové de 2 chambres pour 4 personnes, à 3 minutes à pied du sable. Réservez en direct dès 130 € la nuit — sans commission.',
  ...
  it: {
    ...
    'hero.tagline': 'Appartamento ristrutturato con 2 camere per 4 persone, a 3 minuti a piedi dalla sabbia. Prenota direttamente da 130 € a notte — senza commissioni.',
  ...
  de: {
    ...
    'hero.tagline': 'Renovierte Wohnung mit 2 Schlafzimmern für 4 Gäste, nur 3 Gehminuten vom Sand. Direkt vom Eigentümer ab 130 € pro Nacht — provisionsfrei.',
  ...
  es: {
    ...
    'hero.tagline': 'Apartamento reformado de 2 habitaciones para 4 personas, a 3 minutos andando de la arena. Reserva directa desde 130 € la noche — sin comisiones.',
