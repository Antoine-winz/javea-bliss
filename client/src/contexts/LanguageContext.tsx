...
const translations = {
  en: {
    ...
    'gallery.bedroom3': "Second double bedroom",
  ...
  nl: {
    ...
    'gallery.bedroom3': "Tweede slaapkamer met tweepersoonsbed",
    ...
    'amenityList.wifi': "600 Mbps glasvezel-wifi",
    'amenityList.smartTv': '55-inch Smart TV',
    'amenityList.kitchen': 'Complete Keuken',
    'amenityList.waterFilter': 'Waterfilter',
    'amenityList.washer': "Wasmachine",
    'amenityList.heating': "Verwarming",
    'amenityList.lift': "Lift",
  ...
  fr: {
    ...
    'gallery.bedroom3': "Deuxième chambre avec lit double",
  ...
  it: {
    ...
    'gallery.bedroom3': "Seconda camera matrimoniale",
  ...
  de: {
    ...
    'gallery.bedroom3': "Zweites Schlafzimmer mit Doppelbett",
  ...
  es: {
    ...
    'gallery.bedroom3': "Segunda habitación con cama de matrimonio",
