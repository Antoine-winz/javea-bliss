      ...
      <div className="shell">
        <div className="grid lg:grid-cols-12 gap-y-10 gap-x-16">
          ...
          <div className="lg:col-span-9">
            <ul className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-x-12" data-reveal-stagger>
            ...
            <div className="mt-12" data-reveal>
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-x-12">
