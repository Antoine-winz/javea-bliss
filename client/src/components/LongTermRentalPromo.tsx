...
const LongTermRentalPromo = () => {
  ...
  const translations = {
    en: {
      ...
      access: 'Lift, with free street parking outside',
    ...
    nl: {
      ...
      access: 'Lift, met gratis parkeren op straat',
    ...
    fr: {
      ...
      access: 'Ascenseur, stationnement gratuit dans la rue',
    ...
    de: {
      ...
      access: 'Aufzug, kostenloses Parken auf der Straße',
    ...
    es: {
      ...
      access: 'Ascensor, aparcamiento gratis en la calle',
    ...
    it: {
      ...
      access: 'Ascensore, parcheggio gratuito in strada',
